...
async function fetchData() {
  ...
  let response = await fetch(`https://api.spoonacular.com/recipes/complexSearch?apiKey=e24201e68c7a4406a41930950e2aeef2&intolerances=gluten&number=8&query=${search}&addRecipeInformation=true&offset=${offset}&type=${types}`);
